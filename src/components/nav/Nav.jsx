...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <a href="#experience" onClick={() => setActiveNum('#experience')} className={activeNav === '#experience' ? 'active' : ''}><BiBook /></a>
      <a href="#services" onClick={() => setActiveNum('#services')} className={activeNav === '#services' ? 'active' : ''}><RiServiceLine /></a>
